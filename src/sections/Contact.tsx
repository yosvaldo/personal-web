...
export default function Contact() {
  ...
  const handleSendMessage = (e: FormEvent) => {
    ...
    setTimeout(() => {
      ...
      alert("Message received! I will connect with your engine shortly.");
    }, 1200);
  };
  ...
  return (
    <section id="contact" className="py-16 border-t border-zinc-900/60 scroll-mt-20">
      <div className="flex items-center gap-2 text-orange-400 font-mono text-xs uppercase tracking-widest mb-3">
        <Mail className="w-3.5 h-3.5" /> Pipeline
      </div>
        ...
        <div className="md:col-span-3">
          <form className="space-y-4" onSubmit={handleSendMessage}>
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-semibold text-zinc-950 transition hover:bg-zinc-200 disabled:opacity-50"
            >
        ...
        <div className="md:col-span-2 flex flex-col justify-between gap-6">
          ...
          <div className="p-5 rounded-2xl bg-zinc-900/20 border border-zinc-900 space-y-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://www.linkedin.com/in/yosvaldo-ongko-cahyadi-88857bbb/" target="_blank" rel="noreferrer" className="text-sm text-gray-400 hover:text-white transition">→ LinkedIn</a>
            </div>
          </div>
        </div>
      </div>
